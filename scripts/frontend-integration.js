 ...
 * This file demonstrates how to integrate Questdrift with a web frontend
 */

// For React/Vue/Angular applications
export class QuestdriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuestdriftClient(provider, contractAddress);
